...
Checks:
- Edge.Cuts rectangle exists and is <= 80 x 60 mm (within small tolerance)
- Four M3 mounting holes exist (3.2 mm drill), roughly at (4,4), (76,4), (4,56), (76,56)
...
def main() -> int:
    ...
    if not rect:
        ...
        w = abs(x1 - x0)
        h = abs(y1 - y0)
        if w > 80.05 or h > 60.05:
            print(f"[kicad_outline] Outline too large: {w:.2f} x {h:.2f} mm (max 80 x 60)")
            rc = 1
        else:
